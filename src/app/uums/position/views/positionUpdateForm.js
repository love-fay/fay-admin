...
class UpdateForm extends Component {
    ...
    constructor (props) {
        ...
        this.state = {
            ...
            groupId: props.data.groupId === null ? undefined : props.data.groupId,
        };
    }
            ...
            <Form onSubmit={this.handleSubmit}>
                ...
                <FormItem {...formItemLayout} label="所属部门">
                    {getFieldDecorator('groupId', {
                        ...
                        <GroupSelect orgId={this.state.orgId} allowClear placeholder="请选择所属部门"/>
                    )}
                </FormItem>
...
const PositionUpdateForm = Form.create()(UpdateForm);

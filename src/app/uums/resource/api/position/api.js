...
const findByOrgAndGroupForSelect = (data) => request.post(apiPath.findByOrgAndGroupForSelect, data);
...
export {
    findForPage, findById, findByOrgAndGroupForSelect, save, update, remove, updAvailable, assignUser, unAssignUser,
